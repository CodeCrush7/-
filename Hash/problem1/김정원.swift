...
solution(participant: ["marina", "josipa", "nikola", "vinko", "filipa"], completion: ["josipa", "filipa", "marina", "nikola"]) // "vinko"
solution(participant: ["mislav", "stanko", "mislav", "ana"], completion: ["stanko", "ana", "mislav"]) // "mislav"
solution(participant: ["kelly"], completion: []) // "kelly"
solution(participant: [], completion: []) // "잘못 입력하셨습니다"
...
// 그리고 제한사항도 첫 줄에 구현을 했는데, 참여자와 완주자가 한 명도 없는 경우이거나 참여자 수가 100,000명 이상이 되면 그냥 이 함수를 바로 빠져나가도록 처리했다.
